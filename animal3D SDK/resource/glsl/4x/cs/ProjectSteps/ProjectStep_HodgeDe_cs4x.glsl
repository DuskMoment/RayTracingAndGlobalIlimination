...
void main()
{
	...
	N = GRID_LENGHT;
	 ...
	 float_bufferInOutU[IX2(i, j)] -= 0.5 * (float_bufferInOutU0[IX2(i + 1, j)] - float_bufferInOutU0[IX2(i - 1, j)]) / h;
     float_bufferInOutV[IX2(i, j)] -= 0.5 * (float_bufferInOutU0[IX2(i, j + 1)] - float_bufferInOutU0[IX2(i, j - 1)]) / h;
