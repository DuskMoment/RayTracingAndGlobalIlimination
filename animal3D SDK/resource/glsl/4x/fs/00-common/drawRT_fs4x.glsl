...
//	
	...
	for(int l = 0; l < samples; l++)
	{
		...
		{	
			...
			if(RayCastPlane(rayPos, rayDirection, objPos, model_stack[IDX_LIGHT].modelViewMat[2], model_stack[IDX_LIGHT].modelViewMat[1], 
							model_stack[IDX_LIGHT].modelViewMat[0], room_size, t, hitnrl))
			{
				if(t < minT && t > -1)
				{
