...
a3ret RunFluidSim_GPU(a3_FluidGrid_GPU* gridData, const a3_ShaderProgram* shaderPrograms, a3real dt)
{
	FluidGridAddSourceFromPoint_GPU(gridData, shaderPrograms, gridData->densityBuffer, a3vec2_zero, 10, dt);
