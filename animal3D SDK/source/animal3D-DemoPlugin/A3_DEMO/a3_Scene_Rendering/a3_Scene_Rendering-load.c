...
void a3rendering_init_scene(a3_DemoState const* demoState, a3_Scene_Rendering* scene)
{
    ...
    InitFluidGrid_GPU(scene->fluidGrid_GPU, (a3real)0.5, (a3real)0.001, 20);
    ...
    //FluidGridAddSource(scene->fluidGrid->size, scene->fluidGrid->velocityU, test, (a3real)0.016);
    ...
    //FluidGridAddSource(scene->fluidGrid->size, scene->fluidGrid->density, test, (a3real)1);
